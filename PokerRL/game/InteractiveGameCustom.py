        ...
        while True:
            ...
            while True:
                ...
                if current_player_id in self._seats_human_plays_list:
                    ...
                    print('Action tuple:' + str(action_tuple))
            ...
            print("Repeating last stage showing all hands")
            self._env.render(mode=render_mode, seats_human_plays_list=range(self._env.N_SEATS))
